...
# log transform 
combine$'1_1' <- log(combine$'1_1')
combine$'1_2' <- log(combine$'1_2')
combine$'1_3' <- log(combine$'1_3')
combine$'1_4' <- log(combine$'1_4')
combine$'1_5' <- log(combine$'1_5')
combine$'1_6' <- log(combine$'1_6')
combine$'1_7' <- log(combine$'1_7')
combine$'1_8' <- log(combine$'1_8')
combine$'1_9' <- log(combine$'1_9')

combine$'10_1' <- log(combine$'10_1')
combine$'10_2' <- log(combine$'10_2')
combine$'10_3' <- log(combine$'10_3')
combine$'10_4' <- log(combine$'10_4')
combine$'10_5' <- log(combine$'10_5')
combine$'10_6' <- log(combine$'10_6')
combine$'10_7' <- log(combine$'10_7')
combine$'10_8' <- log(combine$'10_8')

combine$'11_1' <- log(combine$'11_1')
combine$'12_1' <- log(combine$'12_1')
combine$'13_1' <- log(combine$'13_1')
combine$'14_1' <- log(combine$'14_1')
combine$'15_1' <- log(combine$'15_1')
combine$'16_1' <- log(combine$'16_1')
combine$'17_1' <- log(combine$'17_1')
combine$'18_1' <- log(combine$'18_1')
combine$'19_1' <- log(combine$'19_1')

combine$'2_1' <- log(combine$'2_1')
combine$'2_2' <- log(combine$'2_2')
combine$'2_3' <- log(combine$'2_3')
combine$'20_1' <- log(combine$'20_1')
combine$'21_1' <- log(combine$'21_1')
combine$'22_1' <- log(combine$'22_1')
combine$'23_1' <- log(combine$'23_1')
combine$'24_1' <- log(combine$'24_1')
combine$'25_1' <- log(combine$'25_1')
combine$'25_2' <- log(combine$'25_2')
combine$'26_1' <- log(combine$'26_1')
combine$'27_1' <- log(combine$'27_1')
combine$'28_1' <- log(combine$'28_1')
combine$'29_1' <- log(combine$'29_1')

combine$'3_1' <- log(combine$'3_1')
combine$'3_2' <- log(combine$'3_2')
combine$'32_1' <- log(combine$'32_1')
combine$'33_1' <- log(combine$'33_1')
combine$'34_1' <- log(combine$'34_1')
combine$'35_1' <- log(combine$'35_1')
combine$'38_1' <- log(combine$'38_1')
combine$'39_1' <- log(combine$'39_1')

combine$'40_1' <- log(combine$'40_1')
combine$'41_1' <- log(combine$'41_1')
combine$'44_1' <- log(combine$'44_1')
combine$'45_1' <- log(combine$'45_1')
combine$'5_1' <- log(combine$'5_1')
combine$'5_2' <- log(combine$'5_2')
combine$'5_3' <- log(combine$'5_3')
combine$'5_4' <- log(combine$'5_4')
combine$'5_5' <- log(combine$'5_5')
combine$'5_6' <- log(combine$'5_6')
combine$'5_7' <- log(combine$'5_7')
combine$'5_8' <- log(combine$'5_8')

combine$'6_1' <- log(combine$'6_1')
combine$'6_2' <- log(combine$'6_2')
combine$'7_1' <- log(combine$'7_1')
combine$'7_2' <- log(combine$'7_2')
combine$'7_3' <- log(combine$'7_3')
combine$'7_4' <- log(combine$'7_4')
combine$'8_1' <- log(combine$'8_1')
combine$'8_2' <- log(combine$'8_2')
combine$'9_1' <- log(combine$'9_1')
combine$'9_2' <- log(combine$'9_2')

combine$HD01 <- log(combine$HD01)
combine$HD02 <- log(combine$HD02)
combine$HD03 <- log(combine$HD03)
combine$HD04 <- log(combine$HD04)
combine$HD05 <- log(combine$HD05)
combine$HD06 <- log(combine$HD06)
combine$HD07 <- log(combine$HD07)
combine$HD08 <- log(combine$HD08)
combine$HD09 <- log(combine$HD09)
combine$HD10 <- log(combine$HD10)

combine$HD11 <- log(combine$HD11)
combine$HD12 <- log(combine$HD12)
combine$HD13 <- log(combine$HD13)
combine$HD14 <- log(combine$HD14)
combine$HD15 <- log(combine$HD15)
combine$HD16 <- log(combine$HD16)
combine$HD17 <- log(combine$HD17)
combine$HD18 <- log(combine$HD18)
combine$HD19 <- log(combine$HD19)
combine$HD20 <- log(combine$HD20)

combine$HD21 <- log(combine$HD21)
combine$HD22 <- log(combine$HD22)
combine$HD23 <- log(combine$HD23)
combine$HD24 <- log(combine$HD24)
combine$HD25 <- log(combine$HD25)
combine$HD26 <- log(combine$HD26)
combine$HD27 <- log(combine$HD27)
combine$HD28 <- log(combine$HD28)
combine$HD29 <- log(combine$HD29)
combine$HD30 <- log(combine$HD30)

combine$HD31 <- log(combine$HD31)
combine$HD32 <- log(combine$HD32)
combine$HD33 <- log(combine$HD33)
combine$HD34 <- log(combine$HD34)
combine$HD35 <- log(combine$HD35)
combine$HD36 <- log(combine$HD36)
combine$HD37 <- log(combine$HD37)
...
combine$'1_3' <- scale(combine$'1_3')
combine$'1_4' <- scale(combine$'1_4')
combine$'1_5' <- scale(combine$'1_5')
combine$'1_6' <- scale(combine$'1_6')
combine$'1_7' <- scale(combine$'1_7')
combine$'1_8' <- scale(combine$'1_8')
combine$'1_9' <- scale(combine$'1_9')

combine$'10_1' <- scale(combine$'10_1')
combine$'10_2' <- scale(combine$'10_2')
combine$'10_3' <- scale(combine$'10_3')
combine$'10_4' <- scale(combine$'10_4')
combine$'10_5' <- scale(combine$'10_5')
combine$'10_6' <- scale(combine$'10_6')
combine$'10_7' <- scale(combine$'10_7')
combine$'10_8' <- scale(combine$'10_8')

combine$'11_1' <- scale(combine$'11_1')
combine$'12_1' <- scale(combine$'12_1')
combine$'13_1' <- scale(combine$'13_1')
combine$'14_1' <- scale(combine$'14_1')
combine$'15_1' <- scale(combine$'15_1')
combine$'16_1' <- scale(combine$'16_1')
combine$'17_1' <- scale(combine$'17_1')
combine$'18_1' <- scale(combine$'18_1')
combine$'19_1' <- scale(combine$'19_1')

combine$'2_1' <- scale(combine$'2_1')
combine$'2_2' <- scale(combine$'2_2')
combine$'2_3' <- scale(combine$'2_3')
combine$'20_1' <- scale(combine$'20_1')
combine$'21_1' <- scale(combine$'21_1')
combine$'22_1' <- scale(combine$'22_1')
combine$'23_1' <- scale(combine$'23_1')
combine$'24_1' <- scale(combine$'24_1')
combine$'25_1' <- scale(combine$'25_1')
combine$'25_2' <- scale(combine$'25_2')
combine$'26_1' <- scale(combine$'26_1')
combine$'27_1' <- scale(combine$'27_1')
combine$'28_1' <- scale(combine$'28_1')
combine$'29_1' <- scale(combine$'29_1')

combine$'3_1' <- scale(combine$'3_1')
combine$'3_2' <- scale(combine$'3_2')
combine$'32_1' <- scale(combine$'32_1')
combine$'33_1' <- scale(combine$'33_1')
combine$'34_1' <- scale(combine$'34_1')
combine$'35_1' <- scale(combine$'35_1')
combine$'38_1' <- scale(combine$'38_1')
combine$'39_1' <- scale(combine$'39_1')

combine$'40_1' <- scale(combine$'40_1')
combine$'41_1' <- scale(combine$'41_1')
combine$'44_1' <- scale(combine$'44_1')
combine$'45_1' <- scale(combine$'45_1')
combine$'5_1' <- scale(combine$'5_1')
combine$'5_2' <- scale(combine$'5_2')
combine$'5_3' <- scale(combine$'5_3')
combine$'5_4' <- scale(combine$'5_4')
combine$'5_5' <- scale(combine$'5_5')
combine$'5_6' <- scale(combine$'5_6')
combine$'5_7' <- scale(combine$'5_7')
combine$'5_8' <- scale(combine$'5_8')

combine$'6_1' <- scale(combine$'6_1')
combine$'6_2' <- scale(combine$'6_2')
combine$'7_1' <- scale(combine$'7_1')
combine$'7_2' <- scale(combine$'7_2')
combine$'7_3' <- scale(combine$'7_3')
combine$'7_4' <- scale(combine$'7_4')
combine$'8_1' <- scale(combine$'8_1')
combine$'8_2' <- scale(combine$'8_2')
combine$'9_1' <- scale(combine$'9_1')
combine$'9_2' <- scale(combine$'9_2')

combine$HD01 <- scale(combine$HD01)
combine$HD02 <- scale(combine$HD02)
combine$HD03 <- scale(combine$HD03)
combine$HD04 <- scale(combine$HD04)
combine$HD05 <- scale(combine$HD05)
combine$HD06 <- scale(combine$HD06)
combine$HD07 <- scale(combine$HD07)
combine$HD08 <- scale(combine$HD08)
combine$HD09 <- scale(combine$HD09)
combine$HD10 <- scale(combine$HD10)

combine$HD11 <- scale(combine$HD11)
combine$HD12 <- scale(combine$HD12)
combine$HD13 <- scale(combine$HD13)
combine$HD14 <- scale(combine$HD14)
combine$HD15 <- scale(combine$HD15)
combine$HD16 <- scale(combine$HD16)
combine$HD17 <- scale(combine$HD17)
combine$HD18 <- scale(combine$HD18)
combine$HD19 <- scale(combine$HD19)
combine$HD20 <- scale(combine$HD20)

combine$HD21 <- scale(combine$HD21)
combine$HD22 <- scale(combine$HD22)
combine$HD23 <- scale(combine$HD23)
combine$HD24 <- scale(combine$HD24)
combine$HD25 <- scale(combine$HD25)
combine$HD26 <- scale(combine$HD26)
combine$HD27 <- scale(combine$HD27)
combine$HD28 <- scale(combine$HD28)
combine$HD29 <- scale(combine$HD29)
combine$HD30 <- scale(combine$HD30)

combine$HD31 <- scale(combine$HD31)
combine$HD32 <- scale(combine$HD32)
combine$HD33 <- scale(combine$HD33)
combine$HD34 <- scale(combine$HD34)
combine$HD35 <- scale(combine$HD35)
combine$HD36 <- scale(combine$HD36)
combine$HD37 <- scale(combine$HD37)
combine$HD38 <- scale(combine$HD38)
combine$HD39 <- scale(combine$HD39)

transComb <- as.data.frame(t(combine))

# rename cols
colnames(transComb) <- c("TRBV10-1_TRBJ1-1", "TRBV10-1_TRBJ1-2", 
                         ...
                         "TRBV12-1_TRBJ1-5", "TRBV12-1_TRBJ2-2",
                         "TRBV12-1_TRBJ2-3", "TRBV12-1_TRBJ2-4", 
                         "TRBV12-1_TRBJ2-5", "TRBV12-1_TRBJ2-7", 
                         "TRBV12-3_TRBJ1-1", "TRBV12-3_TRBJ1-2", 
                         "TRBV12-3_TRBJ1-3", "TRBV12-3_TRBJ1-4", 
                         "TRBV12-3_TRBJ1-5", "TRBV12-3_TRBJ1-6", 
                         "10_5", "10_6", "10_7", "10_8", "11_1", "12_1", "13_1", 
                         "14_1", "15_1", "16_1", "17_1", "18_1", "19_1", "2_1", 
                         "2_2", "2_3", "20_1", "21_1", "22_1", "23_1", "24_1", 
                         ...
                         "40_1", "41_1", "44_1", "45_1", "5_1", "5_2", "5_3", 
                         "5_4", "5_5", "5_6", "5_7", "5_8", "6_1", "6_2", "7_1", 
                         "7_2", "7_3", "7_4", "8_1", "8_2", "9_1", "9_2", 
                         "HD01", "HD02", "HD03", "HD04", "HD05", "HD06", "HD07", 
                         "HD08", "HD09", "HD10", "HD11", "HD12", "HD13", "HD14", 
                         "HD15", "HD16", "HD17", "HD18", "HD19", "HD20", "HD21", 
                         "HD22", "HD23", "HD24", "HD25", "HD26", "HD27", "HD28", 
                         "HD29", "HD30", "HD31", "HD32", "HD33", "HD34", "HD35", 
                         "HD36", "HD37", "HD38", "HD39")

transComb <- select(transComb, Sample.ID, "TRBV10-1_TRBJ1-1", 
                    ...
                    "TRBV7-6_TRBJ2-5", "TRBV7-6_TRBJ2-6", "TRBV7-7_TRBJ1-2", 
                    ...
                    "TRBV7-8_TRBJ2-1", "TRBV7-8_TRBJ2-2", "TRBV7-8_TRBJ2-3", 
                    "TRBV7-8_TRBJ2-4", "TRBV7-8_TRBJ2-5", "TRBV7-8_TRBJ2-6", 
                    "TRBV7-8_TRBJ2-7", "TRBV7-9_TRBJ1-1", "TRBV7-9_TRBJ1-2", 
                    "TRBV7-9_TRBJ1-3", "TRBV7-9_TRBJ1-4", "TRBV7-9_TRBJ1-5", 
                    "TRBV7-9_TRBJ1-6", "TRBV7-9_TRBJ2-1", "TRBV7-9_TRBJ2-2", 
                    "TRBV7-9_TRBJ2-3", "TRBV7-9_TRBJ2-4", "TRBV7-9_TRBJ2-5", 
                    "TRBV7-9_TRBJ2-6", "TRBV7-9_TRBJ2-7", "TRBV9_TRBJ1-1", 
                    "TRBV9_TRBJ1-2", "TRBV9_TRBJ1-3", "TRBV9_TRBJ1-4", 
                    "TRBV9_TRBJ1-5", "TRBV9_TRBJ1-6", "TRBV9_TRBJ2-1", 
                    "TRBV9_TRBJ2-2", "TRBV9_TRBJ2-3", "TRBV9_TRBJ2-4", 
                    "TRBV9_TRBJ2-5", "TRBV9_TRBJ2-6", "TRBV9_TRBJ2-7")

# combine wide & patients
full <- merge(transComb, patients, by = "Sample.ID", all = TRUE)
...
full <- select(full, patient.ID, Sample.ID, diseae.stage, "TRBV10-1_TRBJ1-1", 
               ...
               "TRBV9_TRBJ2-2", "TRBV9_TRBJ2-3", "TRBV9_TRBJ2-4", 
               "TRBV9_TRBJ2-5", "TRBV9_TRBJ2-6", "TRBV9_TRBJ2-7", 
               days.from.first.symptoms, time, choose, "...7", comment)
...
final <- select(final, patient.ID, Sample.ID, "TRBV10-1_TRBJ1-1", 
                ...
                "TRBV9_TRBJ1-5", "TRBV9_TRBJ1-6", "TRBV9_TRBJ2-1", 
                "TRBV9_TRBJ2-2", "TRBV9_TRBJ2-3", "TRBV9_TRBJ2-4", 
                "TRBV9_TRBJ2-5", "TRBV9_TRBJ2-6", "TRBV9_TRBJ2-7", Y, Y1)
