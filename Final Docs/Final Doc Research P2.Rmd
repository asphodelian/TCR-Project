...
Now after the columns, we will make three subsets based on Y1. This had caused a problem when trying to run the for loops, which we'll dive in that part. Right now, we need to fill in the NAs for Y1.
